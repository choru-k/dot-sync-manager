...
- [ ] [Implement fsnotify watchers for dotfiles repository with debounce logic tuned to PRD latency goals, including the inactivity guard that only triggers auto-commit when the repo has been quiet for the configured period.](https://github.com/choru-k/dot-sync-manager/issues/2)
